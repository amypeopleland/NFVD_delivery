...
public class SetGoods extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Goods te=new Goods();
		te.setGoodsId(goods_id);
		te.setGoodsNumber(goods_number);
		te.setGoodsBid(goods_bid);
		te.setGoodsSell(goods_sell);
		te.setGoodsSum(goods_sum);
		te.setGoodsRemain(goods_remain);
		ts.UpdateGoodsByID(te);
