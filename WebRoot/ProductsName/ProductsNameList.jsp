...
<html>
  <head>
    ...
    <title>My JSP 'ProductsNameList.jsp' starting page</title>
  ...
  //	Priducts t=new Pruducts();
  	for(int i=0;list!=null && i<list.size();i++){
    	...
    	<td align="center"><a href="<%=basePath%>servlet/DeleteProducts?GOODS_number=<%=goods_number%>&flag=1">删除</td>
   		<td align="center"><a href="<%=basePath%>servlet/SetProducts?GOODS_number=<%=goods_number%>&flag=4">修改</td>
  		</tr>
